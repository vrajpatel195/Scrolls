...
class UploadController extends GetxController {
  ...
  saveVideoInformationToFirestoreDatabase(String artistSongname,
      String description, String videoFilePath, BuildContext context) async {
    try {
      ...
      String videoDownloadUrl =
          await uploadCompressedVideoFileToFirebaseStorage(id, videoFilePath);
      String thumbnailDownloadUrl =
          await uploadThumbnailImageToFirebaseStorage(id, videoFilePath);

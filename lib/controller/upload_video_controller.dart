...
class VideoUploadController extends GetxController{
 ...
 Future<String> _uploadVideoThumbToStorage(String id , String videoPath) async{
  ...
  uploadVideo(String songName , String caption , String videoPath, File videoFile) async{
    ...
    //videoID - uuid
    String id  = uuid.v1();
    String videoUrl = await _uploadVideoToStorage( id, videoFile);
  ...
  _compressVideo(String videoPath) async{
    ...
    await VideoCompress.compressVideo(videoPath,
       ...
       print("dddd: ${compressedVideo!.file}");
